    ...
    navContainer.outerHTML = 
      '<nav class="nav">' +
        ...
        '<ul class="nav-links">' +
          ...
          '<li><a href="https://staging.clockchain.network/service/" target="_blank">API/MCP</a></li>' +
        '</ul>' +
        '<div class="nav-right">' +
      ...
      '<div class="mobile-menu" id="mobile-menu" aria-hidden="true">' +
        '<nav class="mm-links" aria-label="Primary (mobile)">' +
          ...
          '<a href="https://staging.clockchain.network/service/">API/MCP</a>' +
      ...
      '<footer class="footer">' +
        '<div class="container-wide">' +
          '<div class="footer-top">' +
            ...
            '<div class="footer-col"><h5>Network</h5><ul><li><a href="https://staging.clockchain.network/service/" target="_blank" rel="noopener">Dev Portal</a></li><li><a href="#" data-contact>Node operators</a></li></ul></div>' +
